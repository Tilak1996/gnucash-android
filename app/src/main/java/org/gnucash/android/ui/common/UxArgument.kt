...
object UxArgument {
     ...
     */
    const val SELECTED_TRANSACTION_IDS: String = "selected_transactions"

    /**
     * Key for the origin account as argument when moving accounts
     */
    const val ORIGIN_ACCOUNT_UID: String = "origin_acccount_uid"

    /**
     * Key for checking whether the passcode is enabled or not
     */
    const val ENABLED_PASSCODE: String = "enabled_passcode"

    /**
     * Key for disabling the passcode
     */
    const val DISABLE_PASSCODE: String = "disable_passcode"
     ...
     */
    const val PASSCODE_CLASS_CALLER: String = "passcode_class_caller"
