...
import org.gnucash.android.model.importer.CommoditiesXmlHandler;
...
public class MigrationHelper {
    ...
    static String getFullyQualifiedAccountName(SQLiteDatabase db, String accountUID){
        ...
        Cursor cursor = db.query(DatabaseSchema.AccountEntry.TABLE_NAME,
                new String[] {DatabaseSchema.AccountEntry.COLUMN_PARENT_ACCOUNT_UID},
        ...
        if (cursor != null && cursor.moveToFirst()){
            parentAccountUID = cursor.getString(cursor.getColumnIndexOrThrow(DatabaseSchema.AccountEntry.COLUMN_PARENT_ACCOUNT_UID));
            cursor.close();
        }

        //get the name of the account
        cursor = db.query(DatabaseSchema.AccountEntry.TABLE_NAME,
        ...
        if (cursor != null && cursor.moveToFirst()){
            accountName = cursor.getString(cursor.getColumnIndexOrThrow(DatabaseSchema.AccountEntry.COLUMN_NAME));
            cursor.close();
        }
    ...
    private static String getGnuCashRootAccountUID(SQLiteDatabase db){
        String condition = DatabaseSchema.AccountEntry.COLUMN_TYPE + "= '" + AccountType.ROOT.name() + "'";
        Cursor cursor =  db.query(DatabaseSchema.AccountEntry.TABLE_NAME,
                null, condition, null, null, null,
                DatabaseSchema.AccountEntry.COLUMN_NAME + " ASC");
        String rootUID = null;
        if (cursor != null && cursor.moveToFirst()){
            rootUID = cursor.getString(cursor.getColumnIndexOrThrow(DatabaseSchema.AccountEntry.COLUMN_UID));
            cursor.close();
        }
        return rootUID;
    }
...
//                        Crashlytics.logException(e);
    ...
    public static int upgradeDbToVersion2(SQLiteDatabase db) {
        int oldVersion;
        String addColumnSql = "ALTER TABLE " + DatabaseSchema.TransactionEntry.TABLE_NAME +
        ...
        String addParentAccountSql = "ALTER TABLE " + DatabaseSchema.AccountEntry.TABLE_NAME +
                " ADD COLUMN " + DatabaseSchema.AccountEntry.COLUMN_PARENT_ACCOUNT_UID + " varchar(255)";
        ...
        cv.put(DatabaseSchema.SplitEntry.COLUMN_TYPE, AccountType.CASH.toString());
        db.update(DatabaseSchema.AccountEntry.TABLE_NAME, cv, null, null);
    ...
    static int upgradeDbToVersion3(SQLiteDatabase db) {
        int oldVersion;
        String addPlaceHolderAccountFlagSql = "ALTER TABLE " + DatabaseSchema.AccountEntry.TABLE_NAME +
                " ADD COLUMN " + DatabaseSchema.AccountEntry.COLUMN_PLACEHOLDER + " tinyint default 0";
    ...
    static int upgradeDbToVersion4(SQLiteDatabase db) {
        int oldVersion;
        String addRecurrencePeriod = "ALTER TABLE " + DatabaseSchema.TransactionEntry.TABLE_NAME +
                " ADD COLUMN recurrence_period integer default 0";

        String addDefaultTransferAccount = "ALTER TABLE " + DatabaseSchema.AccountEntry.TABLE_NAME
                + " ADD COLUMN " + DatabaseSchema.AccountEntry.COLUMN_DEFAULT_TRANSFER_ACCOUNT_UID + " varchar(255)";

        String addAccountColor = " ALTER TABLE " + DatabaseSchema.AccountEntry.TABLE_NAME
                + " ADD COLUMN " + DatabaseSchema.AccountEntry.COLUMN_COLOR_CODE + " varchar(255)";
    ...
    static int upgradeDbToVersion5(SQLiteDatabase db) {
        int oldVersion;
        String addAccountFavorite = " ALTER TABLE " + DatabaseSchema.AccountEntry.TABLE_NAME
                + " ADD COLUMN " + DatabaseSchema.AccountEntry.COLUMN_FAVORITE + " tinyint default 0";
    ...
    static int upgradeDbToVersion6(SQLiteDatabase db) {
        int oldVersion = 5;
        String addFullAccountNameQuery = " ALTER TABLE " + DatabaseSchema.AccountEntry.TABLE_NAME
                + " ADD COLUMN " + DatabaseSchema.AccountEntry.COLUMN_FULL_NAME + " varchar(255) ";
        db.execSQL(addFullAccountNameQuery);

        //update all existing accounts with their fully qualified name
        Cursor cursor = db.query(DatabaseSchema.AccountEntry.TABLE_NAME,
                new String[]{DatabaseSchema.AccountEntry._ID, DatabaseSchema.AccountEntry.COLUMN_UID},
                null, null, null, null, null);
        while(cursor != null && cursor.moveToNext()){
            String uid = cursor.getString(cursor.getColumnIndexOrThrow(DatabaseSchema.AccountEntry.COLUMN_UID));
            ...
            contentValues.put(DatabaseSchema.AccountEntry.COLUMN_FULL_NAME, fullName);

            long id = cursor.getLong(cursor.getColumnIndexOrThrow(DatabaseSchema.AccountEntry._ID));
            db.update(DatabaseSchema.AccountEntry.TABLE_NAME, contentValues, DatabaseSchema.AccountEntry._ID + " = " + id, null);
        }
    ...
    static int upgradeDbToVersion7(SQLiteDatabase db) {
        ...
        try {
            ...
            db.execSQL("ALTER TABLE " + DatabaseSchema.TransactionEntry.TABLE_NAME + " RENAME TO " + DatabaseSchema.TransactionEntry.TABLE_NAME + "_bak");
            // create new transaction table
            db.execSQL("create table " + DatabaseSchema.TransactionEntry.TABLE_NAME + " ("
                    + DatabaseSchema.TransactionEntry._ID + " integer primary key autoincrement, "
                    + DatabaseSchema.TransactionEntry.COLUMN_UID + " varchar(255) not null, "
                    ...
                    + "UNIQUE (" + DatabaseSchema.TransactionEntry.COLUMN_UID + ") "
                    + ");");
            // initialize new transaction table wiht data from old table
            db.execSQL("INSERT INTO " + DatabaseSchema.TransactionEntry.TABLE_NAME + " ( "
                            + DatabaseSchema.TransactionEntry._ID + " , "
                            + DatabaseSchema.TransactionEntry.COLUMN_UID + " , "
                            + DatabaseSchema.TransactionEntry.COLUMN_DESCRIPTION + " , "
                            + DatabaseSchema.TransactionEntry.COLUMN_NOTES + " , "
                            + DatabaseSchema.TransactionEntry.COLUMN_TIMESTAMP + " , "
                            + DatabaseSchema.TransactionEntry.COLUMN_EXPORTED + " , "
                            + DatabaseSchema.TransactionEntry.COLUMN_CURRENCY + " , "
                            + "recurrence_period )  SELECT "
                            + DatabaseSchema.TransactionEntry.TABLE_NAME + "_bak." + DatabaseSchema.TransactionEntry._ID + " , "
                            + DatabaseSchema.TransactionEntry.TABLE_NAME + "_bak." + DatabaseSchema.TransactionEntry.COLUMN_UID + " , "
                            + DatabaseSchema.TransactionEntry.TABLE_NAME + "_bak." + DatabaseSchema.TransactionEntry.COLUMN_DESCRIPTION + " , "
                            + DatabaseSchema.TransactionEntry.TABLE_NAME + "_bak." + DatabaseSchema.TransactionEntry.COLUMN_NOTES + " , "
                            + DatabaseSchema.TransactionEntry.TABLE_NAME + "_bak." + DatabaseSchema.TransactionEntry.COLUMN_TIMESTAMP + " , "
                            + DatabaseSchema.TransactionEntry.TABLE_NAME + "_bak." + DatabaseSchema.TransactionEntry.COLUMN_EXPORTED + " , "
                            + DatabaseSchema.AccountEntry.TABLE_NAME + "." + DatabaseSchema.AccountEntry.COLUMN_CURRENCY + " , "
                            + DatabaseSchema.TransactionEntry.TABLE_NAME + "_bak.recurrence_period"
                            + " FROM " + DatabaseSchema.TransactionEntry.TABLE_NAME + "_bak , " + DatabaseSchema.AccountEntry.TABLE_NAME
                            + " ON " + DatabaseSchema.TransactionEntry.TABLE_NAME + "_bak.account_uid == " + DatabaseSchema.AccountEntry.TABLE_NAME + "." + DatabaseSchema.AccountEntry.COLUMN_UID
            );
            // create split table
            db.execSQL("CREATE TABLE " + DatabaseSchema.SplitEntry.TABLE_NAME + " ("
                    + DatabaseSchema.SplitEntry._ID + " integer primary key autoincrement, "
                    + DatabaseSchema.SplitEntry.COLUMN_UID + " varchar(255) not null, "
                    ...
                    + "FOREIGN KEY (" + DatabaseSchema.SplitEntry.COLUMN_ACCOUNT_UID + ") REFERENCES " + DatabaseSchema.AccountEntry.TABLE_NAME + " (" + DatabaseSchema.AccountEntry.COLUMN_UID + "), "
                    + "FOREIGN KEY (" + DatabaseSchema.SplitEntry.COLUMN_TRANSACTION_UID + ") REFERENCES " + DatabaseSchema.TransactionEntry.TABLE_NAME + " (" + DatabaseSchema.TransactionEntry.COLUMN_UID + "), "
                    + "UNIQUE (" + DatabaseSchema.SplitEntry.COLUMN_UID + ") "
                    + ");");
            ...
            db.execSQL("INSERT INTO " + DatabaseSchema.SplitEntry.TABLE_NAME + " ( "
                            + DatabaseSchema.SplitEntry.COLUMN_UID + " , "
                            + DatabaseSchema.SplitEntry.COLUMN_TYPE + " , "
                            + "amount" + " , "
                            + DatabaseSchema.SplitEntry.COLUMN_ACCOUNT_UID + " , "
                            + DatabaseSchema.SplitEntry.COLUMN_TRANSACTION_UID + " ) SELECT "
                            + "LOWER(HEX(RANDOMBLOB(16))) , "
                            + "CASE WHEN " + DatabaseSchema.AccountEntry.TABLE_NAME + "." + DatabaseSchema.AccountEntry.COLUMN_TYPE + " IN ( 'CASH' , 'BANK', 'ASSET', 'EXPENSE', 'RECEIVABLE', 'STOCK', 'MUTUAL' ) THEN CASE WHEN "
                            + "amount" + " < 0 THEN 'CREDIT' ELSE 'DEBIT' END ELSE CASE WHEN "
                            + "amount" + " < 0 THEN 'DEBIT' ELSE 'CREDIT' END END , "
                            + "ABS ( " + DatabaseSchema.TransactionEntry.TABLE_NAME + "_bak.amount ) , "
                            + DatabaseSchema.TransactionEntry.TABLE_NAME + "_bak.account_uid , "
                            + DatabaseSchema.TransactionEntry.TABLE_NAME + "_bak." + DatabaseSchema.TransactionEntry.COLUMN_UID
                            + " FROM " + DatabaseSchema.TransactionEntry.TABLE_NAME + "_bak , " + DatabaseSchema.AccountEntry.TABLE_NAME
                            + " ON " + DatabaseSchema.TransactionEntry.TABLE_NAME + "_bak.account_uid = " + DatabaseSchema.AccountEntry.TABLE_NAME + "." + DatabaseSchema.AccountEntry.COLUMN_UID
                            + " UNION SELECT "
                            + "LOWER(HEX(RANDOMBLOB(16))) AS " + DatabaseSchema.SplitEntry.COLUMN_UID + " , "
                            + "CASE WHEN " + DatabaseSchema.AccountEntry.TABLE_NAME + "." + DatabaseSchema.AccountEntry.COLUMN_TYPE + " IN ( 'CASH' , 'BANK', 'ASSET', 'EXPENSE', 'RECEIVABLE', 'STOCK', 'MUTUAL' ) THEN CASE WHEN "
                            + "amount" + " < 0 THEN 'DEBIT' ELSE 'CREDIT' END ELSE CASE WHEN "
                            + "amount" + " < 0 THEN 'CREDIT' ELSE 'DEBIT' END END , "
                            + "ABS ( " + DatabaseSchema.TransactionEntry.TABLE_NAME + "_bak.amount ) , "
                            + DatabaseSchema.TransactionEntry.TABLE_NAME + "_bak.double_account_uid , "
                            + DatabaseSchema.TransactionEntry.TABLE_NAME + "_baK." + DatabaseSchema.TransactionEntry.COLUMN_UID
                            + " FROM " + DatabaseSchema.TransactionEntry.TABLE_NAME + "_bak , " + DatabaseSchema.AccountEntry.TABLE_NAME
                            + " ON " + DatabaseSchema.TransactionEntry.TABLE_NAME + "_bak.account_uid = " + DatabaseSchema.AccountEntry.TABLE_NAME + "." + DatabaseSchema.AccountEntry.COLUMN_UID
                            + " WHERE " + DatabaseSchema.TransactionEntry.TABLE_NAME + "_bak.double_account_uid IS NOT NULL"
            );
            // drop backup transaction table
            db.execSQL("DROP TABLE " + DatabaseSchema.TransactionEntry.TABLE_NAME + "_bak");
    ...
    static int upgradeDbToVersion8(SQLiteDatabase db) {
        ...
        try {
            ...
            db.execSQL("CREATE TABLE " + DatabaseSchema.ScheduledActionEntry.TABLE_NAME + " ("
                    ...
                    + ");" + DatabaseHelper.createUpdatedAtTrigger(DatabaseSchema.ScheduledActionEntry.TABLE_NAME));


            //==============================BEGIN TABLE MIGRATIONS ========================================
            Log.i(DatabaseHelper.LOG_TAG, "Migrating accounts table");
            // backup transaction table
            db.execSQL("ALTER TABLE " + DatabaseSchema.AccountEntry.TABLE_NAME + " RENAME TO " + DatabaseSchema.AccountEntry.TABLE_NAME + "_bak");
            // create new transaction table
            db.execSQL("CREATE TABLE " + DatabaseSchema.AccountEntry.TABLE_NAME + " ("
                    ...
                    + ");" + DatabaseHelper.createUpdatedAtTrigger(DatabaseSchema.AccountEntry.TABLE_NAME));

            // initialize new account table with data from old table
            db.execSQL("INSERT INTO " + DatabaseSchema.AccountEntry.TABLE_NAME + " ( "
                            + DatabaseSchema.AccountEntry._ID + ","
                            + DatabaseSchema.AccountEntry.COLUMN_UID + " , "
                            ...
                            + DatabaseSchema.AccountEntry.COLUMN_COLOR_CODE + " , "
                            ...
                            + DatabaseSchema.AccountEntry.COLUMN_PARENT_ACCOUNT_UID + " , "
                            + DatabaseSchema.AccountEntry.COLUMN_DEFAULT_TRANSFER_ACCOUNT_UID
                            + ") SELECT "
                            + DatabaseSchema.AccountEntry.TABLE_NAME + "_bak." + DatabaseSchema.AccountEntry._ID + " , "
                            + DatabaseSchema.AccountEntry.TABLE_NAME + "_bak." + DatabaseSchema.AccountEntry.COLUMN_UID + " , "
                            + DatabaseSchema.AccountEntry.TABLE_NAME + "_bak." + DatabaseSchema.AccountEntry.COLUMN_NAME + " , "
                            + DatabaseSchema.AccountEntry.TABLE_NAME + "_bak." + DatabaseSchema.AccountEntry.COLUMN_TYPE + " , "
                            + DatabaseSchema.AccountEntry.TABLE_NAME + "_bak." + DatabaseSchema.AccountEntry.COLUMN_CURRENCY + " , "
                            + DatabaseSchema.AccountEntry.TABLE_NAME + "_bak." + DatabaseSchema.AccountEntry.COLUMN_COLOR_CODE + " , "
                            + DatabaseSchema.AccountEntry.TABLE_NAME + "_bak." + DatabaseSchema.AccountEntry.COLUMN_FAVORITE + " , "
                            + DatabaseSchema.AccountEntry.TABLE_NAME + "_bak." + DatabaseSchema.AccountEntry.COLUMN_FULL_NAME + " , "
                            + DatabaseSchema.AccountEntry.TABLE_NAME + "_bak." + DatabaseSchema.AccountEntry.COLUMN_PLACEHOLDER + " , "
                            + " CASE WHEN " + DatabaseSchema.AccountEntry.TABLE_NAME + "_bak.type = 'ROOT' THEN 1 ELSE 0 END, "
                            + DatabaseSchema.AccountEntry.TABLE_NAME + "_bak." + DatabaseSchema.AccountEntry.COLUMN_PARENT_ACCOUNT_UID + " , "
                            + DatabaseSchema.AccountEntry.TABLE_NAME + "_bak." + DatabaseSchema.AccountEntry.COLUMN_DEFAULT_TRANSFER_ACCOUNT_UID
                            + " FROM " + DatabaseSchema.AccountEntry.TABLE_NAME + "_bak;"
            );
            ...
            db.execSQL("CREATE TABLE " + DatabaseSchema.TransactionEntry.TABLE_NAME + " ("
                    ...
                    + ");" + DatabaseHelper.createUpdatedAtTrigger(DatabaseSchema.TransactionEntry.TABLE_NAME));
            ...
            db.execSQL("INSERT INTO " + DatabaseSchema.TransactionEntry.TABLE_NAME + " ( "
                            ...
                            + DatabaseSchema.TransactionEntry.COLUMN_EXPORTED + " , "
                            + DatabaseSchema.TransactionEntry.COLUMN_CURRENCY + " , "
                            + DatabaseSchema.TransactionEntry.COLUMN_TEMPLATE
                            + ")  SELECT "
                            + DatabaseSchema.TransactionEntry.TABLE_NAME + "_bak." + DatabaseSchema.TransactionEntry._ID + " , "
                            + DatabaseSchema.TransactionEntry.TABLE_NAME + "_bak." + DatabaseSchema.TransactionEntry.COLUMN_UID + " , "
                            + DatabaseSchema.TransactionEntry.TABLE_NAME + "_bak." + DatabaseSchema.TransactionEntry.COLUMN_DESCRIPTION + " , "
                            ...
                            + DatabaseSchema.TransactionEntry.TABLE_NAME + "_bak." + DatabaseSchema.TransactionEntry.COLUMN_TIMESTAMP + " , "
                            + DatabaseSchema.TransactionEntry.TABLE_NAME + "_bak." + DatabaseSchema.TransactionEntry.COLUMN_EXPORTED + " , "
                            + DatabaseSchema.TransactionEntry.TABLE_NAME + "_bak." + DatabaseSchema.TransactionEntry.COLUMN_CURRENCY + " , "
                            + " CASE WHEN " + DatabaseSchema.TransactionEntry.TABLE_NAME + "_bak.recurrence_period > 0 THEN 1 ELSE 0 END "
                            + " FROM " + DatabaseSchema.TransactionEntry.TABLE_NAME + "_bak;"
            );

            Log.i(DatabaseHelper.LOG_TAG, "Migrating splits table");
            // backup split table
            db.execSQL("ALTER TABLE " + DatabaseSchema.SplitEntry.TABLE_NAME + " RENAME TO " + DatabaseSchema.SplitEntry.TABLE_NAME + "_bak");
            ...
            db.execSQL("CREATE TABLE " + DatabaseSchema.SplitEntry.TABLE_NAME + " ("
                    ...
                    + ");" + DatabaseHelper.createUpdatedAtTrigger(DatabaseSchema.SplitEntry.TABLE_NAME));

            // initialize new split table with data from old table
            db.execSQL("INSERT INTO " + DatabaseSchema.SplitEntry.TABLE_NAME + " ( "
                            + DatabaseSchema.SplitEntry._ID + " , "
                            + DatabaseSchema.SplitEntry.COLUMN_UID + " , "
                            + DatabaseSchema.SplitEntry.COLUMN_MEMO + " , "
                            + DatabaseSchema.SplitEntry.COLUMN_TYPE + " , "
                            + "amount" + " , "
                            + DatabaseSchema.SplitEntry.COLUMN_ACCOUNT_UID + " , "
                            + DatabaseSchema.SplitEntry.COLUMN_TRANSACTION_UID
                            + ")  SELECT "
                            + DatabaseSchema.SplitEntry.TABLE_NAME + "_bak." + DatabaseSchema.SplitEntry._ID + " , "
                            + DatabaseSchema.SplitEntry.TABLE_NAME + "_bak." + DatabaseSchema.SplitEntry.COLUMN_UID + " , "
                            + DatabaseSchema.SplitEntry.TABLE_NAME + "_bak." + DatabaseSchema.SplitEntry.COLUMN_MEMO + " , "
                            + DatabaseSchema.SplitEntry.TABLE_NAME + "_bak." + DatabaseSchema.SplitEntry.COLUMN_TYPE + " , "
                            + DatabaseSchema.SplitEntry.TABLE_NAME + "_bak." + "amount" + " , "
                            + DatabaseSchema.SplitEntry.TABLE_NAME + "_bak." + DatabaseSchema.SplitEntry.COLUMN_ACCOUNT_UID + " , "
                            + DatabaseSchema.SplitEntry.TABLE_NAME + "_bak." + DatabaseSchema.SplitEntry.COLUMN_TRANSACTION_UID
                            + " FROM " + DatabaseSchema.SplitEntry.TABLE_NAME + "_bak;"
            );
            ...
            try {
                if (cursor.moveToFirst()) {
                    rootAccountUID = cursor.getString(cursor.getColumnIndexOrThrow(DatabaseSchema.AccountEntry.COLUMN_UID));
                }
                else
                {
                    ...
                    contentValues.put(DatabaseSchema.AccountEntry.COLUMN_NAME,         "ROOT");
                    contentValues.put(DatabaseSchema.AccountEntry.COLUMN_TYPE,         "ROOT");
                    contentValues.put(DatabaseSchema.AccountEntry.COLUMN_CURRENCY,     Money.DEFAULT_CURRENCY_CODE);
                    contentValues.put(DatabaseSchema.AccountEntry.COLUMN_PLACEHOLDER,  0);
                    contentValues.put(DatabaseSchema.AccountEntry.COLUMN_HIDDEN,       1);
                    contentValues.putNull(DatabaseSchema.AccountEntry.COLUMN_COLOR_CODE);
                    contentValues.put(DatabaseSchema.AccountEntry.COLUMN_FAVORITE, 0);
                    contentValues.put(DatabaseSchema.AccountEntry.COLUMN_FULL_NAME,    " ");
                    contentValues.putNull(DatabaseSchema.AccountEntry.COLUMN_PARENT_ACCOUNT_UID);
                    contentValues.putNull(DatabaseSchema.AccountEntry.COLUMN_DEFAULT_TRANSFER_ACCOUNT_UID);
                    db.insert(DatabaseSchema.AccountEntry.TABLE_NAME, null, contentValues);
                }
            } finally {
                cursor.close();
            }
            ...
            contentValues.clear();
            contentValues.put(DatabaseSchema.AccountEntry.COLUMN_PARENT_ACCOUNT_UID, rootAccountUID);
            db.update(DatabaseSchema.AccountEntry.TABLE_NAME, contentValues, DatabaseSchema.AccountEntry.COLUMN_PARENT_ACCOUNT_UID + " IS NULL AND " + DatabaseSchema.AccountEntry.COLUMN_TYPE + " != ?", new String[]{"ROOT"});

            Log.i(DatabaseHelper.LOG_TAG, "Migrating existing recurring transactions");
            cursor = db.query(DatabaseSchema.TransactionEntry.TABLE_NAME + "_bak", null, "recurrence_period > 0", null, null, null, null);
            long lastRun = System.currentTimeMillis();
            while (cursor.moveToNext()){
                contentValues.clear();
                Timestamp timestampT = new Timestamp(cursor.getLong(cursor.getColumnIndexOrThrow(DatabaseSchema.TransactionEntry.COLUMN_TIMESTAMP)));
                contentValues.put(DatabaseSchema.TransactionEntry.COLUMN_CREATED_AT, TimestampHelper.getUtcStringFromTimestamp(timestampT));
                long transactionId = cursor.getLong(cursor.getColumnIndexOrThrow(DatabaseSchema.TransactionEntry._ID));
                db.update(DatabaseSchema.TransactionEntry.TABLE_NAME, contentValues, DatabaseSchema.TransactionEntry._ID + "=" + transactionId, null);
                ...
                contentValues.put(DatabaseSchema.CommonColumns.COLUMN_CREATED_AT, timestamp);
                contentValues.put(DatabaseSchema.ScheduledActionEntry.COLUMN_ACTION_UID, cursor.getString(cursor.getColumnIndexOrThrow(DatabaseSchema.TransactionEntry.COLUMN_UID)));
                contentValues.put("period", cursor.getLong(cursor.getColumnIndexOrThrow("recurrence_period")));
                contentValues.put(DatabaseSchema.ScheduledActionEntry.COLUMN_START_TIME, timestampT.getTime());
                contentValues.put(DatabaseSchema.ScheduledActionEntry.COLUMN_END_TIME, 0);
                contentValues.put(DatabaseSchema.ScheduledActionEntry.COLUMN_LAST_RUN, lastRun);
                contentValues.put(DatabaseSchema.ScheduledActionEntry.COLUMN_TYPE, "TRANSACTION");
                contentValues.put(DatabaseSchema.ScheduledActionEntry.COLUMN_TAG, "");
                contentValues.put(DatabaseSchema.ScheduledActionEntry.COLUMN_ENABLED, 1);
                contentValues.put(DatabaseSchema.ScheduledActionEntry.COLUMN_TOTAL_FREQUENCY, 0);
                contentValues.put(DatabaseSchema.ScheduledActionEntry.COLUMN_EXECUTION_COUNT, 0);
                //scheduledActionDbAdapter.addRecord(scheduledAction);
                db.insert(DatabaseSchema.ScheduledActionEntry.TABLE_NAME, null, contentValues);
            ...
            cursor = db.query(
                    DatabaseSchema.TransactionEntry.TABLE_NAME + " , " + DatabaseSchema.SplitEntry.TABLE_NAME + " ON "
                            + DatabaseSchema.TransactionEntry.TABLE_NAME + "." + DatabaseSchema.TransactionEntry.COLUMN_UID + "=" + DatabaseSchema.SplitEntry.TABLE_NAME + "." + DatabaseSchema.SplitEntry.COLUMN_TRANSACTION_UID
                            + " , " + DatabaseSchema.AccountEntry.TABLE_NAME + " ON "
                            + DatabaseSchema.SplitEntry.TABLE_NAME + "." + DatabaseSchema.SplitEntry.COLUMN_ACCOUNT_UID + "=" + DatabaseSchema.AccountEntry.TABLE_NAME + "." + DatabaseSchema.AccountEntry.COLUMN_UID,
                    new String[]{
                            DatabaseSchema.TransactionEntry.TABLE_NAME + "." + DatabaseSchema.TransactionEntry.COLUMN_UID + " AS trans_uid",
                            DatabaseSchema.TransactionEntry.TABLE_NAME + "." + DatabaseSchema.TransactionEntry.COLUMN_CURRENCY + " AS trans_currency",
                            "TOTAL ( CASE WHEN " +
                                    DatabaseSchema.SplitEntry.TABLE_NAME + "." + DatabaseSchema.SplitEntry.COLUMN_TYPE + " = 'DEBIT' THEN " +
                                    DatabaseSchema.SplitEntry.TABLE_NAME + "." + "amount" + " ELSE - " +
                                    DatabaseSchema.SplitEntry.TABLE_NAME + "." + "amount" + " END ) AS trans_acct_balance",
                            "COUNT ( DISTINCT " +
                                    DatabaseSchema.AccountEntry.TABLE_NAME + "." + DatabaseSchema.AccountEntry.COLUMN_CURRENCY +
                                    " ) AS trans_currency_count"
                    },
                    DatabaseSchema.TransactionEntry.TABLE_NAME + "." + DatabaseSchema.TransactionEntry.COLUMN_TEMPLATE + " == 0",
                    null,
            ...
            try {
                while (cursor.moveToNext()){
                    ...
                    if (decimalImbalance.compareTo(BigDecimal.ZERO) != 0) {
                        ...
                        Cursor c = db.query(DatabaseSchema.AccountEntry.TABLE_NAME, new String[]{DatabaseSchema.AccountEntry.COLUMN_UID},
                                DatabaseSchema.AccountEntry.COLUMN_FULL_NAME + "= ?", new String[]{imbalanceAccountName},
                                null, null, null);
                        try {
                            if (c.moveToFirst()) {
                                imbalanceAccountUID = c.getString(c.getColumnIndexOrThrow(DatabaseSchema.AccountEntry.COLUMN_UID));
                            }
                            else {
                                ...
                                contentValues.put(DatabaseSchema.CommonColumns.COLUMN_CREATED_AT, timestamp);
                                contentValues.put(DatabaseSchema.AccountEntry.COLUMN_NAME,         imbalanceAccountName);
                                contentValues.put(DatabaseSchema.AccountEntry.COLUMN_TYPE,         "BANK");
                                contentValues.put(DatabaseSchema.AccountEntry.COLUMN_CURRENCY,     currencyCode);
                                contentValues.put(DatabaseSchema.AccountEntry.COLUMN_PLACEHOLDER,  0);
                                contentValues.put(DatabaseSchema.AccountEntry.COLUMN_HIDDEN,       GnuCashApplication.isDoubleEntryEnabled() ? 0 : 1);
                                contentValues.putNull(DatabaseSchema.AccountEntry.COLUMN_COLOR_CODE);
                                contentValues.put(DatabaseSchema.AccountEntry.COLUMN_FAVORITE, 0);
                                contentValues.put(DatabaseSchema.AccountEntry.COLUMN_FULL_NAME,    imbalanceAccountName);
                                contentValues.put(DatabaseSchema.AccountEntry.COLUMN_PARENT_ACCOUNT_UID, rootAccountUID);
                                contentValues.putNull(DatabaseSchema.AccountEntry.COLUMN_DEFAULT_TRANSFER_ACCOUNT_UID);
                                db.insert(DatabaseSchema.AccountEntry.TABLE_NAME, null, contentValues);
                            }
                        ...
                        contentValues.put(DatabaseSchema.SplitEntry.COLUMN_TYPE,       decimalImbalance.compareTo(BigDecimal.ZERO) < 0 ? "DEBIT" : "CREDIT");
                        contentValues.put(DatabaseSchema.SplitEntry.COLUMN_MEMO,       "");
                        contentValues.put(DatabaseSchema.SplitEntry.COLUMN_ACCOUNT_UID, imbalanceAccountUID);
                        contentValues.put(DatabaseSchema.SplitEntry.COLUMN_TRANSACTION_UID, TransactionUID);
                        db.insert(DatabaseSchema.SplitEntry.TABLE_NAME, null, contentValues);
                        contentValues.clear();
                        contentValues.put(DatabaseSchema.TransactionEntry.COLUMN_MODIFIED_AT, timestamp);
                        db.update(DatabaseSchema.TransactionEntry.TABLE_NAME, contentValues, DatabaseSchema.TransactionEntry.COLUMN_UID + " == ?",
            ...
            db.execSQL("DROP TABLE " + DatabaseSchema.SplitEntry.TABLE_NAME + "_bak");
            db.execSQL("DROP TABLE " + DatabaseSchema.AccountEntry.TABLE_NAME + "_bak");
            db.execSQL("DROP TABLE " + DatabaseSchema.TransactionEntry.TABLE_NAME + "_bak");
    ...
    static int upgradeDbToVersion9(SQLiteDatabase db){
        ...
        db.beginTransaction();
        try {
            db.execSQL("CREATE TABLE " + DatabaseSchema.CommodityEntry.TABLE_NAME + " ("
                    ...
                    + ");" + DatabaseHelper.createUpdatedAtTrigger(DatabaseSchema.CommodityEntry.TABLE_NAME));
            db.execSQL("CREATE UNIQUE INDEX '" + DatabaseSchema.CommodityEntry.INDEX_UID
...
//                Crashlytics.logException(e);
            ...
            db.execSQL(" ALTER TABLE " + DatabaseSchema.AccountEntry.TABLE_NAME
                    + " ADD COLUMN " + DatabaseSchema.AccountEntry.COLUMN_COMMODITY_UID + " varchar(255) "
                    + " REFERENCES " + DatabaseSchema.CommodityEntry.TABLE_NAME + " (" + DatabaseSchema.CommodityEntry.COLUMN_UID + ") ");

            db.execSQL(" ALTER TABLE " + DatabaseSchema.TransactionEntry.TABLE_NAME
                    + " ADD COLUMN " + DatabaseSchema.TransactionEntry.COLUMN_COMMODITY_UID + " varchar(255) "
                    + " REFERENCES " + DatabaseSchema.CommodityEntry.TABLE_NAME + " (" + DatabaseSchema.CommodityEntry.COLUMN_UID + ") ");

            db.execSQL("UPDATE " + DatabaseSchema.AccountEntry.TABLE_NAME + " SET " + DatabaseSchema.AccountEntry.COLUMN_COMMODITY_UID + " = "
                    + " (SELECT " + DatabaseSchema.CommodityEntry.COLUMN_UID
                    + " FROM " + DatabaseSchema.CommodityEntry.TABLE_NAME
                    + " WHERE " + DatabaseSchema.AccountEntry.TABLE_NAME + "." + DatabaseSchema.AccountEntry.COLUMN_COMMODITY_UID + " = " + DatabaseSchema.CommodityEntry.TABLE_NAME + "." + DatabaseSchema.CommodityEntry.COLUMN_UID
                    + ")");

            db.execSQL("UPDATE " + DatabaseSchema.TransactionEntry.TABLE_NAME + " SET " + DatabaseSchema.TransactionEntry.COLUMN_COMMODITY_UID + " = "
                    + " (SELECT " + DatabaseSchema.CommodityEntry.COLUMN_UID
                    + " FROM " + DatabaseSchema.CommodityEntry.TABLE_NAME
                    + " WHERE " + DatabaseSchema.TransactionEntry.TABLE_NAME + "." + DatabaseSchema.TransactionEntry.COLUMN_COMMODITY_UID + " = " + DatabaseSchema.CommodityEntry.TABLE_NAME + "." + DatabaseSchema.CommodityEntry.COLUMN_UID
                    + ")");

            db.execSQL("CREATE TABLE " + DatabaseSchema.PriceEntry.TABLE_NAME + " ("
                    ...
                    + ");" + DatabaseHelper.createUpdatedAtTrigger(DatabaseSchema.PriceEntry.TABLE_NAME));
            db.execSQL("CREATE UNIQUE INDEX '" + DatabaseSchema.PriceEntry.INDEX_UID
            ...
            db.execSQL("INSERT INTO " + DatabaseSchema.SplitEntry.TABLE_NAME + " ( "
                    ...
                    + DatabaseSchema.SplitEntry.COLUMN_MEMO            + " , "
                    + DatabaseSchema.SplitEntry.COLUMN_TYPE            + " , "
                    + DatabaseSchema.SplitEntry.COLUMN_VALUE_NUM       + " , "
                    + DatabaseSchema.SplitEntry.COLUMN_VALUE_DENOM     + " , "
                    + DatabaseSchema.SplitEntry.COLUMN_QUANTITY_NUM    + " , "
                    + DatabaseSchema.SplitEntry.COLUMN_QUANTITY_DENOM  + " , "
                    + DatabaseSchema.SplitEntry.COLUMN_ACCOUNT_UID     + " , "
                    + DatabaseSchema.SplitEntry.COLUMN_TRANSACTION_UID
                    + ")  SELECT "
                    + DatabaseSchema.SplitEntry.TABLE_NAME + "_bak." + DatabaseSchema.SplitEntry._ID + " , "
                    ...
                    + DatabaseSchema.SplitEntry.TABLE_NAME + "_bak." + DatabaseSchema.SplitEntry.COLUMN_MEMO + " , "
                    + DatabaseSchema.SplitEntry.TABLE_NAME + "_bak." + DatabaseSchema.SplitEntry.COLUMN_TYPE + " , "
                    + DatabaseSchema.SplitEntry.TABLE_NAME + "_bak.amount * 100, " //we will update this value in the next steps
                    + "100, "
                    + DatabaseSchema.SplitEntry.TABLE_NAME + "_bak.amount * 100, " //default units of 2 decimal places were assumed until now
                    + "100, "
                    + DatabaseSchema.SplitEntry.TABLE_NAME + "_bak." + DatabaseSchema.SplitEntry.COLUMN_ACCOUNT_UID + " , "
                    + DatabaseSchema.SplitEntry.TABLE_NAME + "_bak." + DatabaseSchema.SplitEntry.COLUMN_TRANSACTION_UID
                    + " FROM " + DatabaseSchema.SplitEntry.TABLE_NAME + "_bak;");
            ...
            String query = "SELECT " + "A." + DatabaseSchema.AccountEntry.COLUMN_UID + " AS account_uid "
                    + " FROM " + DatabaseSchema.AccountEntry.TABLE_NAME + " AS A, " + DatabaseSchema.CommodityEntry.TABLE_NAME + " AS C "
                    + " WHERE A." + DatabaseSchema.AccountEntry.COLUMN_CURRENCY + " = C." + DatabaseSchema.CommodityEntry.COLUMN_MNEMONIC
                    + " AND C." + DatabaseSchema.CommodityEntry.COLUMN_SMALLEST_FRACTION + "= 1";
            ...
            db.execSQL("REPLACE INTO " + DatabaseSchema.SplitEntry.TABLE_NAME + " ( "
                    + DatabaseSchema.SplitEntry.COLUMN_UID + " , "
                    + DatabaseSchema.SplitEntry.COLUMN_MEMO + " , "
                    + DatabaseSchema.SplitEntry.COLUMN_TYPE + " , "
                    + DatabaseSchema.SplitEntry.COLUMN_ACCOUNT_UID + " , "
                    + DatabaseSchema.SplitEntry.COLUMN_TRANSACTION_UID + " , "
                    + DatabaseSchema.SplitEntry.COLUMN_CREATED_AT + " , "
                    + DatabaseSchema.SplitEntry.COLUMN_MODIFIED_AT + " , "
                    + DatabaseSchema.SplitEntry.COLUMN_VALUE_NUM + " , "
                    + DatabaseSchema.SplitEntry.COLUMN_VALUE_DENOM + " , "
                    + DatabaseSchema.SplitEntry.COLUMN_QUANTITY_NUM + " , "
                    + DatabaseSchema.SplitEntry.COLUMN_QUANTITY_DENOM
                    ...
                    + DatabaseSchema.SplitEntry.COLUMN_CREATED_AT + " , "
                    + DatabaseSchema.SplitEntry.COLUMN_MODIFIED_AT + " , "
                    + " ROUND (" + DatabaseSchema.SplitEntry.COLUMN_VALUE_NUM + "/ 100), "
                    + "1, "
                    + " ROUND (" + DatabaseSchema.SplitEntry.COLUMN_QUANTITY_NUM + "/ 100), "
                    + "1 "
                    + " FROM " + DatabaseSchema.SplitEntry.TABLE_NAME
                    + " WHERE " + DatabaseSchema.SplitEntry.COLUMN_ACCOUNT_UID + " IN ('" + accounts + "')"
                    + ";");



            //************ UPDATE SPLITS WITH CURRENCIES HAVING 3 DECIMAL PLACES *******************
            query = "SELECT " + "A." + DatabaseSchema.AccountEntry.COLUMN_UID + " AS account_uid "
                    + " FROM " + DatabaseSchema.AccountEntry.TABLE_NAME + " AS A, " + DatabaseSchema.CommodityEntry.TABLE_NAME + " AS C "
                    + " WHERE A." + DatabaseSchema.AccountEntry.COLUMN_CURRENCY + " = C." + DatabaseSchema.CommodityEntry.COLUMN_MNEMONIC
                    + " AND C." + DatabaseSchema.CommodityEntry.COLUMN_SMALLEST_FRACTION + "= 1000";
            ...
            db.execSQL("REPLACE INTO " + DatabaseSchema.SplitEntry.TABLE_NAME + " ( "
                    ...
                    + DatabaseSchema.SplitEntry.COLUMN_CREATED_AT  + " , "
                    + DatabaseSchema.SplitEntry.COLUMN_MODIFIED_AT + " , "
                    + DatabaseSchema.SplitEntry.COLUMN_VALUE_NUM + "* 10, " //add an extra zero because we used only 2 digits before
                    + "1000, "
                    + DatabaseSchema.SplitEntry.COLUMN_QUANTITY_NUM + "* 10, "
                    + "1000 "
                    + " FROM " + DatabaseSchema.SplitEntry.TABLE_NAME
                    + " WHERE " + DatabaseSchema.SplitEntry.COLUMN_ACCOUNT_UID + " IN ('" + accounts + "')"
                    + ";");
    ...
    static int upgradeDbToVersion10(SQLiteDatabase db){
        ...
        db.beginTransaction();
        try {
            Cursor cursor = db.query(DatabaseSchema.ScheduledActionEntry.TABLE_NAME,
                    new String[]{DatabaseSchema.ScheduledActionEntry.COLUMN_UID, DatabaseSchema.ScheduledActionEntry.COLUMN_TAG},
            ...
            ContentValues contentValues = new ContentValues();
            while (cursor.moveToNext()){
                String paramString = cursor.getString(cursor.getColumnIndexOrThrow(DatabaseSchema.ScheduledActionEntry.COLUMN_TAG));
                ...
                String uid = cursor.getString(cursor.getColumnIndexOrThrow(DatabaseSchema.ScheduledActionEntry.COLUMN_UID));
                contentValues.clear();
                contentValues.put(DatabaseSchema.ScheduledActionEntry.COLUMN_UID, uid);
                contentValues.put(DatabaseSchema.ScheduledActionEntry.COLUMN_TAG, params.toCsv());
                db.insert(DatabaseSchema.ScheduledActionEntry.TABLE_NAME, null, contentValues);
            }
    ...
    static int upgradeDbToVersion11(SQLiteDatabase db){
        ...
        db.beginTransaction();
        try {
            Cursor cursor = db.query(DatabaseSchema.ScheduledActionEntry.TABLE_NAME, null,
                    DatabaseSchema.ScheduledActionEntry.COLUMN_TYPE + "= ?",
            ...
            while (cursor.moveToNext()) {
                String uid = cursor.getString(cursor.getColumnIndexOrThrow(DatabaseSchema.ScheduledActionEntry.COLUMN_UID));
                String tag = cursor.getString(cursor.getColumnIndexOrThrow(DatabaseSchema.ScheduledActionEntry.COLUMN_TAG));
            ...
            for (Map.Entry<String, String> entry : uidToTagMap.entrySet()) {
                contentValues.clear();
                contentValues.put(DatabaseSchema.ScheduledActionEntry.COLUMN_TAG, entry.getValue());
                db.update(DatabaseSchema.ScheduledActionEntry.TABLE_NAME, contentValues,
                        DatabaseSchema.ScheduledActionEntry.COLUMN_UID + " = ?", new String[]{entry.getKey()});
            }
    ...
    static int upgradeDbToVersion13(SQLiteDatabase db){
        ...
        db.beginTransaction();
        try {
            db.execSQL("CREATE TABLE " + DatabaseSchema.RecurrenceEntry.TABLE_NAME + " ("
                    ...
                    + DatabaseHelper.createUpdatedAtTrigger(DatabaseSchema.RecurrenceEntry.TABLE_NAME));
            ...
            db.execSQL("CREATE UNIQUE INDEX '" + DatabaseSchema.BudgetEntry.INDEX_UID
                    + "' ON " + DatabaseSchema.BudgetEntry.TABLE_NAME + "(" + DatabaseSchema.BudgetEntry.COLUMN_UID + ")");

            db.execSQL("CREATE TABLE " + DatabaseSchema.BudgetAmountEntry.TABLE_NAME + " ("
                    ...
                    + ");" + DatabaseHelper.createUpdatedAtTrigger(DatabaseSchema.BudgetAmountEntry.TABLE_NAME));

            db.execSQL("CREATE UNIQUE INDEX '" + DatabaseSchema.BudgetAmountEntry.INDEX_UID
            ...
            db.execSQL("ALTER TABLE " + DatabaseSchema.ScheduledActionEntry.TABLE_NAME + " RENAME TO " + DatabaseSchema.ScheduledActionEntry.TABLE_NAME + "_bak");
            ...
            // initialize new transaction table with data from old table
            db.execSQL("INSERT INTO " + DatabaseSchema.ScheduledActionEntry.TABLE_NAME + " ( "
                            + DatabaseSchema.ScheduledActionEntry._ID + " , "
                            + DatabaseSchema.ScheduledActionEntry.COLUMN_UID + " , "
                            + DatabaseSchema.ScheduledActionEntry.COLUMN_ACTION_UID + " , "
                            + DatabaseSchema.ScheduledActionEntry.COLUMN_TYPE + " , "
                            + DatabaseSchema.ScheduledActionEntry.COLUMN_LAST_RUN + " , "
                            + DatabaseSchema.ScheduledActionEntry.COLUMN_START_TIME + " , "
                            + DatabaseSchema.ScheduledActionEntry.COLUMN_END_TIME + " , "
                            + DatabaseSchema.ScheduledActionEntry.COLUMN_ENABLED + " , "
                            + DatabaseSchema.ScheduledActionEntry.COLUMN_TOTAL_FREQUENCY + " , "
                            + DatabaseSchema.ScheduledActionEntry.COLUMN_EXECUTION_COUNT + " , "
                            + DatabaseSchema.ScheduledActionEntry.COLUMN_CREATED_AT + " , "
                            + DatabaseSchema.ScheduledActionEntry.COLUMN_MODIFIED_AT + " , "
                            + DatabaseSchema.ScheduledActionEntry.COLUMN_RECURRENCE_UID + " , "
                            + DatabaseSchema.ScheduledActionEntry.COLUMN_TEMPLATE_ACCT_UID + " , "
                            + DatabaseSchema.ScheduledActionEntry.COLUMN_TAG
                            + ")  SELECT "
                            + DatabaseSchema.ScheduledActionEntry.TABLE_NAME + "_bak." + DatabaseSchema.ScheduledActionEntry._ID + " , "
                            + DatabaseSchema.ScheduledActionEntry.TABLE_NAME + "_bak." + DatabaseSchema.ScheduledActionEntry.COLUMN_UID + " , "
                            + DatabaseSchema.ScheduledActionEntry.TABLE_NAME + "_bak." + DatabaseSchema.ScheduledActionEntry.COLUMN_ACTION_UID + " , "
                            + DatabaseSchema.ScheduledActionEntry.TABLE_NAME + "_bak." + DatabaseSchema.ScheduledActionEntry.COLUMN_TYPE + " , "
                            + DatabaseSchema.ScheduledActionEntry.TABLE_NAME + "_bak." + DatabaseSchema.ScheduledActionEntry.COLUMN_LAST_RUN + " , "
                            + DatabaseSchema.ScheduledActionEntry.TABLE_NAME + "_bak." + DatabaseSchema.ScheduledActionEntry.COLUMN_START_TIME + " , "
                            + DatabaseSchema.ScheduledActionEntry.TABLE_NAME + "_bak." + DatabaseSchema.ScheduledActionEntry.COLUMN_END_TIME + " , "
                            + DatabaseSchema.ScheduledActionEntry.TABLE_NAME + "_bak." + DatabaseSchema.ScheduledActionEntry.COLUMN_ENABLED + " , "
                            + DatabaseSchema.ScheduledActionEntry.TABLE_NAME + "_bak." + DatabaseSchema.ScheduledActionEntry.COLUMN_TOTAL_FREQUENCY + " , "
                            + DatabaseSchema.ScheduledActionEntry.TABLE_NAME + "_bak." + DatabaseSchema.ScheduledActionEntry.COLUMN_EXECUTION_COUNT + " , "
                            + DatabaseSchema.ScheduledActionEntry.TABLE_NAME + "_bak." + DatabaseSchema.ScheduledActionEntry.COLUMN_CREATED_AT + " , "
                            + DatabaseSchema.ScheduledActionEntry.TABLE_NAME + "_bak." + DatabaseSchema.ScheduledActionEntry.COLUMN_MODIFIED_AT + " , "
                            + " 'dummy-string' ," //will be updated in next steps
                            + " 'dummy-string' ,"
                            + DatabaseSchema.ScheduledActionEntry.TABLE_NAME + "_bak." + DatabaseSchema.ScheduledActionEntry.COLUMN_TAG
                            + " FROM " + DatabaseSchema.ScheduledActionEntry.TABLE_NAME + "_bak;");

            //update the template-account-guid and the recurrence guid for all scheduled actions
            Cursor cursor = db.query(DatabaseSchema.ScheduledActionEntry.TABLE_NAME + "_bak",
                    new String[]{DatabaseSchema.ScheduledActionEntry.COLUMN_UID,
                            "period",
                            DatabaseSchema.ScheduledActionEntry.COLUMN_START_TIME
                    },
                    null, null, null, null, null);
            ...
            while (cursor.moveToNext()){
                ...
                long startTime = cursor.getLong(cursor.getColumnIndexOrThrow(DatabaseSchema.ScheduledActionEntry.COLUMN_START_TIME));
                Recurrence recurrence = Recurrence.fromLegacyPeriod(period);
                recurrence.setPeriodStart(new Timestamp(startTime));

                contentValues.clear();
                contentValues.put(DatabaseSchema.RecurrenceEntry.COLUMN_UID, recurrence.getUID());
                contentValues.put(DatabaseSchema.RecurrenceEntry.COLUMN_MULTIPLIER, recurrence.getMultiplier());
                contentValues.put(DatabaseSchema.RecurrenceEntry.COLUMN_PERIOD_TYPE, recurrence.getPeriodType().name());
                contentValues.put(DatabaseSchema.RecurrenceEntry.COLUMN_PERIOD_START, recurrence.getPeriodStart().toString());
                db.insert(DatabaseSchema.RecurrenceEntry.TABLE_NAME, null, contentValues);

                contentValues.clear();
                contentValues.put(DatabaseSchema.ScheduledActionEntry.COLUMN_RECURRENCE_UID, recurrence.getUID());
                contentValues.put(DatabaseSchema.ScheduledActionEntry.COLUMN_TEMPLATE_ACCT_UID, BaseModel.generateUID());
                db.update(DatabaseSchema.ScheduledActionEntry.TABLE_NAME, contentValues,
                        DatabaseSchema.ScheduledActionEntry.COLUMN_UID + " = ?", new String[]{uid});
            }
            cursor.close();

            db.execSQL("DROP TABLE " + DatabaseSchema.ScheduledActionEntry.TABLE_NAME + "_bak");
            ...
            db.execSQL("INSERT INTO " + DatabaseSchema.SplitEntry.TABLE_NAME + " ( "
                    ...
                    + DatabaseSchema.SplitEntry.TABLE_NAME + "_bak." + DatabaseSchema.SplitEntry.COLUMN_MEMO          + " , "
                    + DatabaseSchema.SplitEntry.TABLE_NAME + "_bak." + DatabaseSchema.SplitEntry.COLUMN_TYPE          + " , "
                    + DatabaseSchema.SplitEntry.TABLE_NAME + "_bak." + DatabaseSchema.SplitEntry.COLUMN_VALUE_NUM     + " , "
                    + DatabaseSchema.SplitEntry.TABLE_NAME + "_bak." + DatabaseSchema.SplitEntry.COLUMN_VALUE_DENOM   + " , "
                    + DatabaseSchema.SplitEntry.TABLE_NAME + "_bak." + DatabaseSchema.SplitEntry.COLUMN_QUANTITY_NUM  + " , "
                    + DatabaseSchema.SplitEntry.TABLE_NAME + "_bak." + DatabaseSchema.SplitEntry.COLUMN_QUANTITY_DENOM + " , "
                    + DatabaseSchema.SplitEntry.TABLE_NAME + "_bak." + DatabaseSchema.SplitEntry.COLUMN_ACCOUNT_UID   + " , "
                    + DatabaseSchema.SplitEntry.TABLE_NAME + "_bak." + DatabaseSchema.SplitEntry.COLUMN_TRANSACTION_UID
                    + " FROM " + DatabaseSchema.SplitEntry.TABLE_NAME + "_bak;");
    ...
    static int upgradeDbToVersion15(SQLiteDatabase db) {
        ...
        try {
            ...
            db.update(
                    ...
                    contentValues,
                    DatabaseSchema.AccountEntry.TABLE_NAME + "." + DatabaseSchema.AccountEntry.COLUMN_DEFAULT_TRANSFER_ACCOUNT_UID
                            + " NOT IN (SELECT " + DatabaseSchema.AccountEntry.COLUMN_UID
                            + "             FROM " + DatabaseSchema.AccountEntry.TABLE_NAME + ")",
                    null);
            db.setTransactionSuccessful();
            dbVersion = 15;
        } finally {
